...
**Navigation**: [Documentation Hub](../index.md) > [Validation](index.md) > Getting Started
...
**Previous**: [Validation Hub](index.md) | **Next**: [Core Concepts](user-guide/core-concepts.md)
