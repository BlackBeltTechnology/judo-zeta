...
/**
 * Represents a target type definition for a transformation rule.
 * Contains the resource alias and element type from a @To annotation.
 */
public final class ToDefinition {
    private final String alias;
    private final Class<? extends EObject> type;

    /**
     * Create a new ToDefinition.
     *
     * @param alias the resource alias
     * @param type the element type
     */
    public ToDefinition(String alias, Class<? extends EObject> type) {
    ...
    public boolean equals(Object o) {
        ...
        ToDefinition that = (ToDefinition) o;
