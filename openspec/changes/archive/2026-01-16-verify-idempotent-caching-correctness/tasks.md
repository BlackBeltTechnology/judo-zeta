...
## Phase 1: Add Tests Verifying Correct Behavior ✅ COMPLETE

- [x] 1.1 Create `IdempotentCachingTest.java` verifying Zeta's correct behavior
...
- [x] 1.2 Add test for multi-context rule invocation
...
- [x] 1.3 Add test verifying idempotent cache key design
...
- [x] 1.4 Add test verifying uniform ID generation
...
## Phase 2: Document ETL Bug and Correct Behavior ✅ COMPLETE

- [x] 2.1 Update `docs/transformation/etl-comparison/feature-parity.md`
...
- [x] 2.2 Add inline documentation to `ElementResolutionCache.java`
...
- [x] 2.3 Add inline documentation to `TransformationContext.equivalent()`
...
## Phase 3: Update Specs ✅ COMPLETE

- [x] 3.1 Update `etl-patterns` spec
  - Document ETL compound ID bug
  - Clarify Zeta's correct idempotent behavior
  - Include scenarios showing expected behavior
- [x] 3.2 Review `greedy-target-lookup` spec
  - Verify it correctly documents idempotent caching
  - Add note that calling context does not affect lookup

## Phase 4: Validation ✅ COMPLETE

- [x] 4.1 Run all transformation-core tests (608 tests pass, 15 skipped)
- [x] 4.2 Verify new tests pass (confirming correct behavior)
- [x] 4.3 Run `openspec validate verify-idempotent-caching-correctness --strict`
