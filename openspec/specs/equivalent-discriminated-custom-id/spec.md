# equivalent-discriminated-custom-id Specification

## Purpose
Governs the `customId` parameter on `equivalentDiscriminated()` that enables explicit XMI ID override for discriminated clones.
